...
echo "" > all.js
for i in jquery-1.9.1.min.js jquery-migrate-1.2.1.js jstorage.js history.adapter.jquery.js history.js mustache.js encoder.js URI.js json2.js qrcodejs/qrcode.js 
do
	cat ../vendor/$i >> all.js
	echo ";" >> all.js
done
